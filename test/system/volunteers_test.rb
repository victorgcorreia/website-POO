...
class VolunteersTest < ApplicationSystemTestCase
  ...
  test "creating a Volunteer" do
    ...
    fill_in "Bio", with: @volunteer.bio
    fill_in "Birthdate", with: @volunteer.birthdate
    fill_in "Cpf", with: @volunteer.cpf
    fill_in "Tel", with: @volunteer.tel
    fill_in "User", with: @volunteer.user_id
