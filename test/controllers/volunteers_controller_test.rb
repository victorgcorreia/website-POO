...
class VolunteersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post volunteers_url, params: { volunteer: { address: @volunteer.address, bio: @volunteer.bio, birthdate: @volunteer.birthdate, cpf: @volunteer.cpf, tel: @volunteer.tel, user_id: @volunteer.user_id } }
    end
  ...
  test "should update volunteer" do
    patch volunteer_url(@volunteer), params: { volunteer: { address: @volunteer.address, bio: @volunteer.bio, birthdate: @volunteer.birthdate, cpf: @volunteer.cpf, tel: @volunteer.tel, user_id: @volunteer.user_id } }
